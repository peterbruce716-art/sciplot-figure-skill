...
PLOT_CAPABILITIES = {
    ...
    "grouped_bar": PlotCapability("grouped_bar", "draw_grouped_bar", "extract_bar_semantics", frozenset({"x", "groups"}), frozenset({"bar_width", "bar_widths", "group_mode", "group_offset", "group_offsets", "alpha", "errorbar_color", "errorbar_line_width_pt", "errorbar_capsize"}), frozenset({"x_hash", "groups", "point_count"}), "strict_supported", True),
