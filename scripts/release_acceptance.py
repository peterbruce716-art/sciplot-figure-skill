...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="sfr-release-") as tmp:
        ...
        steps = [
            ...
            ("semantic_plot_matrix", [sys.executable, "-m", "unittest", "discover", "-s", str(SCRIPTS / "tests"), "-p", "test_integration_plots.py"]),
            ("style_and_cjk_delivery", [sys.executable, "-m", "unittest", "discover", "-s", str(SCRIPTS / "tests"), "-p", "test_ai_and_version.py"]),
            ("object_reconstruction", [sys.executable, "-m", "unittest", "discover", "-s", str(SCRIPTS / "tests"), "-p", "test_object_reconstruction.py"]),
            ("pdf_trace", [sys.executable, "-m", "unittest", "discover", "-s", str(SCRIPTS / "tests"), "-p", "test_pdf_vector_trace_safety.py"]),
