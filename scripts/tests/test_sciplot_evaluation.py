...
class SciPlotEvaluationTests(unittest.TestCase):
    ...
    def test_quick_entrypoints_preserve_contracts_and_skip_heavy_gates(self) -> None:
        ...
        self.assertEqual({"schema", "status", "selected_profile", "project", "input_hash", "input_hashes", "outputs", "report", "performance"}, set(result))
        ...
        self.assertEqual(set(PASS_CHECKS) | {"schema", "status", "selected_profile", "enabled_gates", "input_hashes", "output_selection"}, set(report))
        ...
        self.assertEqual(set(PASS_CHECKS) | {"schema", "status", "profile", "project", "manifest_validation"}, set(result))
    ...
    def test_standard_pass_preserves_contracts_and_legacy_entrypoints(self) -> None:
        ...
        self.assertEqual(set(PASS_CHECKS) | {"schema", "status", "selected_profile", "enabled_gates", "input_hashes", "output_selection", "checksums", "environment_summary", "manifest_validation"}, set(report))
        for gate in PASS_CHECKS:
